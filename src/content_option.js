...
const dataportfolio = [
  ...
  },
  {
    coverImg: AI1,
    popupImg: AI2,
    title: "Analisis Prediksi Menggunakan Algoritma Machine Decision Tree dan Naive Bayes Menggunakan Dataset",
    shortDesc: "Sistem analisis prediksi berbasis Machine Learning",
    description:
      "Sistem analisis prediksi menggunakan algoritma Machine Learning Decision Tree dan Naive Bayes dengan dataset yang tersedia.",
    tech: ["Python", "Decision Tree", "Naive Bayes", "Pandas", "Scikit-Learn"],
    link: "#",
  },
];
